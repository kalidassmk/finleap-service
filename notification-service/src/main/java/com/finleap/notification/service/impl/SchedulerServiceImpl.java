...
public class SchedulerServiceImpl implements SchedulerService {
	...
	public boolean addSchedule(Schedule schedule) {
		...
		try {  ActorSystem actorSystem = ActorSystem.create("SchedulerService");

			ActorRef scheduleActor = system.actorOf(SPRING_EXTENSION_PROVIDER.get(system).props("schedulerActor"), "schedulerActor");
